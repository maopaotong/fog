            ...
            for (int x = 0; x < width; x++)
            {
                for (int y = 0; y < height; y++)
                {
                    ...
                    for (int i = 0; i < 5; i++)
                    {
                        ...
                        cKeys[i] = CellsTransform::Transform<Cell::PointyTop>::transform<Cell::Centre,Cell::Offset>(points[i]);
                    ...
                    Vector2 tileCentreP = CellsTransform::Transform<Cell::PointyTop>::transform<Cell::Offset,Cell::Centre>(cKeys[0]);
                    //
                        ...
                        ht = calculateRectHeightBySamples(points[0], [this, &cells](float x, float y)
                                                          {
                                                              ...
                                                              CellKey cKey = CellsTransform::Transform<Cell::PointyTop>::transform<Cell::Centre,Cell::Offset>(Point2<float>(x, y));
