...
namespace fog
{
    ...
    public:
        ...
        void set(CellKey cKey, bool visible)
        {
            ...
            //
            Point2<float> centreP = CellsTransform::Transform<Cell::PointyTop>::transform<CellsTransform::K2P>(cKey).transform(Transform::D2CellWorldUV(tlsWidth, tlsHeight));
        ...
        void onMoving(Actor *state)
        {
            ...
            //     this->set(cis, true);
            // }
            CellKey cis = CellsTransform::Transform<Cell::PointyTop>::transform<CellsTransform::P2K>(state->getPosition(*tfs->d3d2));
            this->set(cis, true);
        }
