...
namespace fog
{
    ...
    struct CellsGroup
    {
        ...
        Box2<float> getBoxIn2D(K &cKey)
        {
            ...
            Point2<float> centre = CellsTransform::transform<K, Cell::PointyCentre>(cKey);
        ...
        static Box2<float> getOuterBoxIn2D(K &cKey)
        {
            ...
            Point2<float> centre = CellsTransform::transform<std::tuple<K, Point2<float>, Cell::PointyCentre>>(cKey);
